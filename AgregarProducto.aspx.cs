...
public partial class AgregarProducto : System.Web.UI.Page
{
    ...
    protected void btnAgregar_Click(object sender, EventArgs e)
    {
        ...
        string oNombreArchivoFotoChica=Path.GetFileName(flpAgregaFotoChica.PostedFile.FileName);
        ...
        string oNombreArchivoFotoGrande = Path.GetFileName(flpAgregaFotoGrande.PostedFile.FileName);
